    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sleeper_seat1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("1 LB");
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            if (doc.exists()){
                                ...
                                intent= new Intent(Activity_sleeper_coach.this,Activity_seat_detail.class);
        ...
        sleeper_seat2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("2 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
        ...
        sleeper_seat3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("3 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
        ...
        sleeper_seat4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("4 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
        ...
        sleeper_seat5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("5 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("6 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("7 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("8 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("9 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
            ...
            public void onClick(View v) {
                ...
                DocumentReference docref = FirebaseFirestore.getInstance().collection("Services").document("Sleeper").collection(date +str1).document("10 LB");
                docref.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
